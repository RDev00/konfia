  ...
  return (
    <main className="w-full h-full bg-gray-900">
      <div className="flex flex-col justify-center items-center gap-2 fixed top-[50%] left-[50%] transform-[translate(-50%,-50%)_scale(1.1)] text-center">
        ...
        <a href="/" className="border border-blue-400 bg-blue-400 font-bold px-4 py-1 rounded-md cursor-pointer duration-250 mt-3 hover:scale-110 hover:border-white hover:bg-white hover:text-black"> Regresar al inicio </a>
      </div>
    </main>
  )
}
