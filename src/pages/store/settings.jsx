...
import { mdiHomeCircle, mdiAccountCircle, mdiShieldEditOutline, mdiHelp, mdiBugOutline, mdiScaleBalance, mdiDeleteOutline, mdiLogout, mdiSquareEditOutline } from '@mdi/js';
...
export default function StoreSettings() {
	...
	const changePassword = async(e) => {
		...
		const insertedNewPassword = form.querySelector('input[name="konfia-new-username');
		const insertedPassword = form.querySelector('input[name="konfia-password');

		if(!insertedNewPassword || !insertedPassword) {
			const res = await updateStore(insertedNewPassword.value, null, insertedPassword.value);
			setUsernameFormMessage(res.message);
