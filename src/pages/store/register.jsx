...
export default function StoreRegister(){
	...
	return (
		<LayoutForms>
			<FormLayout formRef={form} submitText="Registrarme" messageRef={message} function={(e) => HandleSubmit(e)} redirectionText="¿Ya tienes cuenta?" link="/store/login" linkText="Inicia sesion!">
